...
class CategorySelectAdapter(private val selectCategory: MealType?, private val onClick: (MealType) -> Unit) : RecyclerView.Adapter<CategorySelectAdapter.CategoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) = holder.bind(MealType.ARRAY[position])
